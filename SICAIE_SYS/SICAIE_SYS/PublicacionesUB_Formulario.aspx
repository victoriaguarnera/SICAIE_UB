...
<link rel="stylesheet" href="css/sicaie-ub.css">
    ...
    <div class="altaNot" >
        <div class="altaNot-box col-xs-12">
            ...
            <asp:TextBox ID="txtTitulo" runat="server" cssclass="form-control" Height="28px" Width="100%" MaxLength="50"></asp:TextBox>
            <br />
            <label><asp:Label ID="lblSubtitulo" runat="server" CssClass="TextoFormulario" Text="Subtitulo"></asp:Label></label>
            <asp:TextBox ID="txtSubtitulo" runat="server" cssclass="form-control" Height="28px" Width="100%" MaxLength="50"></asp:TextBox>
            <br />
